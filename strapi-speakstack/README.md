...
matheapp-f/lib/screens/teacher/teacher_home_screen.dart
matheapp-f/lib/app_start.dart          (teacher tab branch)
matheapp-f/assets/locales/en.json      (teacher.* keys)
```
...
matheapp-f/lib/services/classroom_service.dart
matheapp-f/lib/screens/teacher/teacher_classes_screen.dart
matheapp-f/lib/screens/teacher/teacher_class_detail_screen.dart
matheapp-f/lib/screens/profile/join_class_screen.dart
```
...
matheapp-f/lib/screens/teacher/teacher_class_roster_tab.dart
matheapp-f/lib/screens/teacher/teacher_student_snapshot_screen.dart
matheapp-f/lib/services/classroom_service.dart            (getRoster)
```
