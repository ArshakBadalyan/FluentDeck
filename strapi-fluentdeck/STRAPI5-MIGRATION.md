...
FluentDeck API runs **Strapi 5.49.0** (upgraded from 4.26.x).
...
- FluentDeck-critical utils migrated off `__TODO__` placeholders
...
- Native v5: set `STRAPI_RESPONSE_FORMAT=v5` in `assets/fluentdeck_config.txt`
